...
class Character(models.Model):
    ...
    culture = models.CharField(max_length=200, null=True, blank=True)
    ...
    born = models.CharField(max_length=200, null=True, blank=True)
    died = models.CharField(max_length=200, null=True, blank=True)
